...
/// Pure frontend metadata endpoints that remain available while draining.
/// Every other matched route is admitted as engine work by default, so newly
/// added generation or utility endpoints cannot bypass the drain counter.
